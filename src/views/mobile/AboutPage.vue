        ...
        <f7-popup push swipe-to-close swipe-handler=".swipe-handler" class="license-popup">
            <f7-page>
                ...
                <f7-block strong outline class="license-content no-margin-top">
                    ...
                    <hr/>
                    <p>
                        <span>AbelFinance's codebase and localization translation rely on contributions from the community. The following people have contributed to AbelFinance:</span>
                    </p>
                    <div>
                    ...
                    <p class="margin-top margin-bottom">
                        <span>AbelFinance also contains additional third party software and illustration.</span><br/>
